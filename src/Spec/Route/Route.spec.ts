    ...
    it('should correctly identify routes with one or more url params', () => {
        const routes = [
            ...
            },
            {
                ...
                generate: (args: Array<string>) =>
                    `/one/${args[0]}/three/${args[1]}`,
            },
            {
                route: '/one/:two/three/:four/:five',
                generate: (args: Array<string>) =>
                    `/one/${args[0]}/three/${args[1]}/${args[2]}`,
            },
        ];
        ...
        const routes = [
            {
                route: '/one/:two/three/:four/:five',
                generate: (args) =>
                    `/one/${args.two}/three/${args.four}/${args.five}`,
            },
            {
                route: '/something/:two/else/:four/:five',
                generate: (args) =>
                    `/something/${args.two}/else/${args.four}/${args.five}`,
            },
        ];
